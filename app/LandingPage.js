...
export default function LandingPage() {
  ...
  return (
    <>
   {(!openEditor) ? (<div className="lp-container">
        <Confetti
    ...
    />
      <div className="lp-nav">
        ...
        <button className="btn btn-secondary prj-btn" onClick={()=>handleAdd()}>Add Yours</button>
      </div>
      <section className="hero-section">
        <div className="hero">CENTER OF EXCELLENCE</div>
        <div className="hero-sub">It's time to create your own WIKI</div>
      </section>
     {(!openEditor) && <section className="search-section">
        <svg
      ...
      <section className="editor-section">
       { (!openEditor) ? <div className="editor"></div> :
